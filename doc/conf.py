...
extensions = ['sphinx.ext.autodoc', 'sphinx.ext.todo', 'sphinx.ext.linkcode']
...
project = u'MDT'
copyright = u'1989-2015, Andrej Sali, Ben Webb'
...
# Add external links to source code on GitHub
def linkcode_resolve(domain, info):
    ...
    if filename == 'mdt':
        filename = 'mdt/__init__'
    return "https://github.com/salilab/mdt/blob/develop/pyext/%s.py" % filename
