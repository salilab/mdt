...
\lstinputlisting[frame=trbl, frameround=tttt]{#1}
\end{description} \ \\[-2mm]}

\newcommand{\IncludePDF}[1]{
  \includepdf[pages=-,nup=4,scale=0.85,frame]{#1}
}

% avoid filenames with _, a nuissance:
\newcommand{\Include}[1]{
\lstinputlisting[aboveskip=2mm, belowskip=2mm, xleftmargin = 6mm,
title={
{\em File:} 
\htmladdnormallink{{\tt #1}}{file://#1}
},
frame=trbl, frameround=tttt]{#1} 
}

% avoid filenames with _, a nuissance:
\newcommand{\IncludeOut}[2]{
\lstinputlisting[aboveskip=2mm, belowskip=2mm, xleftmargin = 6mm, basicstyle=\small,
title={
\rule{6mm}{0mm}{\em File:}
\htmladdnormallink{{\tt #1}}{file://#1} \\
\rule{6mm}{0mm}{\em Output:}
\htmladdnormallink{{\tt #2}}{file://#2}
},
frame=trbl, frameround=tttt]{#1} 
}
